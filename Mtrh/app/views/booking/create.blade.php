...
<table id = "tabler"  >
      ...
      <th colspan = "2"> Fill The Form To Book An Appoindment</th>
        ...
        <tr>
             ...
             <td>{{Form::input('text','section_to_visit')}}{{ $errors->first('name', '<span class=error>:message></span>') }}</td>
        ...
        <tr>
             ...
             <td>{{Form::input('text','doctor_assigned')}}{{ $errors->first('name', '<span class=error>:message></span>') }}</td>
        </tr>
        <tr>
